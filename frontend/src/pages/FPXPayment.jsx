...
export default function FPXPayment() {
  ...
  if (isProcessing) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#FFFFFF' }}>
        <div className="bg-white rounded-2xl p-8 max-w-md w-full mx-4 text-center border border-slate-200 shadow-lg">
          <div className="mb-8">
        ...
        <div className="w-full" style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div className="bg-white rounded-xl p-6 mb-6 border border-slate-200 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-teal-600 font-bold">Blockchain Verified Payment</h3>
                <p className="text-slate-500 text-sm">Transaction secured on the blockchain</p>
              </div>
            </div>
            <div className="bg-slate-50 rounded-lg p-4 mb-3 border border-slate-200">
              <p className="text-slate-400 text-xs uppercase tracking-wider mb-1">Transaction Hash</p>
              <code className="text-teal-600 text-xs font-mono break-all">{invoiceData.blockchainTxHash}</code>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-slate-50 rounded-lg p-3 border border-slate-200">
                <p className="text-slate-400 text-xs">Block Number</p>
                <p className="text-slate-800 font-mono">#{invoiceData.blockNumber?.toLocaleString()}</p>
              </div>
              <div className="bg-slate-50 rounded-lg p-3 border border-slate-200">
                <p className="text-slate-400 text-xs">Network</p>
                <p className="text-teal-600 font-semibold text-sm">{invoiceData.blockchainNetwork}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 mb-6 border border-slate-200 shadow-sm">
            ...
            <div className="border-t border-slate-200 pt-4 mb-4">
              {invoiceData.items.map((item, index) => (
                <div key={index} className="flex justify-between py-2 text-slate-600">
            ...
            <div className="border-t border-slate-200 pt-4">
              ...
              <div className="flex justify-between py-2 text-xl font-bold text-slate-800">
                ...
                <span className="text-green-600">RM {invoiceData.total.toLocaleString()}</span>
              </div>
            </div>

            <div className="mt-4 p-4 bg-slate-50 rounded-lg text-sm text-slate-500 border border-slate-200">
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-5 mb-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-emerald-700 font-bold text-lg">{isTopUp ? 'Credits Added' : 'Credits Loaded'}</p>
                  <p className="text-slate-500 text-sm">{isTopUp ? `+${pricing.credits.toLocaleString()} credits added` : 'Ready for MC issuance'}</p>
                </div>
              </div>
              <div className="text-right">
                {isTopUp ? (
                  <>
                    <p className="text-3xl font-black text-slate-800">RM {newBalance.toLocaleString()}</p>
                    <p className="text-emerald-600 text-sm">New Balance</p>
                  </>
                ) : (
                  <>
                    <p className="text-3xl font-black text-slate-800">RM {initialCredits.toLocaleString()}</p>
                    <p className="text-emerald-600 text-sm">{initialCredits} MC credits</p>
                  </>
                )}
              </div>
            </div>
          ...
          {/* Node Status */}
          <div className="bg-white rounded-xl p-6 mb-6 border border-slate-200 shadow-sm">
            <h3 className="text-lg font-semibold text-slate-800 mb-4">Your Hospital Node</h3>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                <div className="text-slate-500 text-sm">{isTopUp ? 'New Balance' : 'Credit Balance'}</div>
                <div className="text-emerald-600 font-bold">RM {(isTopUp ? newBalance : initialCredits).toLocaleString()}</div>
              </div>
              <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                <div className="text-slate-500 text-sm">Plan</div>
                <div className="text-slate-800 font-bold">Enterprise</div>
              </div>
              <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                <div className="text-slate-500 text-sm">{isTopUp ? 'Transaction ID' : 'Next Billing'}</div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-blue-700 font-semibold">Receipt Sent Successfully</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {/* Print Official Receipt - MedChain Gold */}
            <button
              onClick={() => {
                downloadInvoice();
              }}
              className="print-btn py-3 px-6 rounded-lg font-bold transition-all flex items-center justify-center gap-2 border-2"
              style={{
            ...
            <button
              ...
              className="bg-slate-100 hover:bg-slate-200 text-slate-700 py-3 px-6 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 border border-slate-200"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              ...
              {isTopUp ? 'Go to Dashboard' : 'Connect Wallet'}
            </button>
          </div>
        </div>
      </div>
  ...
  return (
    <div
      ...
      style={{ backgroundColor: '#FFFFFF', width: '100%', padding: '40px' }}
    >
      {/* Global CSS for seamless background */}
      <style>{`
        html, body, #root {
      ...
      <div className="w-full" style={{ maxWidth: '1100px', margin: '0 auto', padding: '40px 0' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          <h1 style={{ fontSize: '32px', fontWeight: 700, color: '#1E293B', marginBottom: '12px', letterSpacing: '-0.5px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '24px', alignItems: 'stretch' }}>
          ...
          >
            <h2 style={{ fontSize: '18px', fontWeight: 700, color: '#1E293B', marginBottom: '24px' }}>Order Summary</h2>

            {/* Credit Package Options for Top-Up */}
            {isTopUp && (
              <div style={{ marginBottom: '24px' }}>
                <p style={{ fontSize: '11px', fontWeight: 600, color: '#94A3B8', marginBottom: '12px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                  ...
                  {CREDIT_PACKAGES.map((pkg) => (
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: '12px',
                        border: selectedPackage === pkg.id ? '2px solid #14b8a6' : '1px solid #E2E8F0',
                        backgroundColor: selectedPackage === pkg.id ? 'rgba(20, 184, 166, 0.06)' : '#F8FAFC',
                        cursor: 'pointer',
                        textAlign: 'left',
                        position: 'relative'
                      }}
                    >
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flex: 1 }}>
                        <div style={{
                          ...
                          height: '20px',
                          borderRadius: '50%',
                          border: selectedPackage === pkg.id ? '2px solid #14b8a6' : '2px solid #CBD5E1',
                          display: 'flex',
                          alignItems: 'center',
                        ...
                        {pkg.id === 'custom' ? (
                          <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: '12px' }}>
                            <span style={{ color: '#1E293B', fontSize: '14px', fontWeight: 500 }}>Custom:</span>
                            <input
                              type="number"
                            ...
                            />
                            <span style={{ color: '#94A3B8', fontSize: '12px' }}>@ RM 1.00 each</span>
                          </div>
                        ) : (
                          <div style={{ flex: 1 }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                              <span style={{ color: '#1E293B', fontSize: '15px', fontWeight: 600 }}>{pkg.credits.toLocaleString()} MC Credits</span>
                              {pkg.popular && (
                                <span style={{
                                  fontSize: '9px',
                                  fontWeight: 700,
                            ...
                            <span style={{ color: '#94A3B8', fontSize: '12px' }}>RM {pkg.perCredit.toFixed(2)} per credit</span>
                          </div>
                        )}
                      </div>
                      ...
                      {pkg.id !== 'custom' && (
                        <div style={{ textAlign: 'right' }}>
                          <div style={{ color: '#1E293B', fontSize: '16px', fontWeight: 700 }}>RM {pkg.price.toLocaleString()}</div>
                        </div>
                      )}
                    </button>
                  ))}
              ...
              <>
                <div style={{ borderBottom: '1px solid #E2E8F0', paddingBottom: '16px', marginBottom: '16px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div>
                      <div style={{ color: '#1E293B', fontWeight: 500 }}>Enterprise Subscription</div>
                      <div style={{ color: '#94A3B8', fontSize: '13px' }}>Monthly fee</div>
                    </div>
                    <div style={{ color: '#1E293B', fontWeight: 700 }}>RM 10,000</div>
                  </div>
                </div>
                <div style={{ borderBottom: '1px solid #E2E8F0', paddingBottom: '16px', marginBottom: '16px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                    <div>
                      <div style={{ color: '#1E293B', fontWeight: 500 }}>Initial Credits</div>
                      <div style={{ color: '#94A3B8', fontSize: '13px' }}>RM 1.00 per MC transaction</div>
                    </div>
                    <div style={{ color: '#1E293B', fontWeight: 700 }}>RM {initialCredits}</div>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                    <input
                      ...
                      style={{ flex: 1, height: '8px', borderRadius: '4px', appearance: 'none', background: '#E2E8F0', cursor: 'pointer' }}
                    />
                    <span style={{
                      fontSize: '13px',
                      fontWeight: 600,
            ...
            {/* Order Calculation */}
            <div style={{ borderTop: '1px solid #E2E8F0', paddingTop: '16px', marginTop: isTopUp ? '0' : '16px' }}>
              {selectedPackage && isTopUp && (
                <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 0', color: '#64748B', fontSize: '14px' }}>
                  <span>Credits</span>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '16px 0 8px', borderTop: '1px solid #E2E8F0', marginTop: '8px' }}>
            ...
            <div style={{
              ...
              <div style={{ color: '#1E293B', fontWeight: 600, fontSize: '15px' }}>{agreementData?.hospitalName || 'Hospital'}</div>
          ...
          >
            <h2 style={{ fontSize: '18px', fontWeight: 700, color: '#1E293B', marginBottom: '8px' }}>Select Your Bank</h2>
              ...
              {MALAYSIAN_BANKS.map((bank) => (
                <button
                  ...
                  style={{
                    padding: '14px 12px',
                    borderRadius: '10px',
                    border: selectedBank === bank.code ? '2px solid #14b8a6' : '1px solid #E2E8F0',
                    backgroundColor: selectedBank === bank.code ? 'rgba(20, 184, 166, 0.06)' : '#F8FAFC',
                    cursor: 'pointer',
                    display: 'flex',
                    flexDirection: 'column',
                    alignItems: 'center',
                ...
                >
                  <div style={{
                    ...
                    justifyContent: 'center',
                    fontSize: '18px',
                    backgroundColor: selectedBank === bank.code ? 'rgba(20, 184, 166, 0.15)' : '#F1F5F9'
                  }}>
                    {bank.logo}
                  </div>
                  <div style={{
                    fontSize: '11px',
                    fontWeight: 500,
                    color: selectedBank === bank.code ? '#14b8a6' : '#64748B',
                    textAlign: 'center'
                  }}>
                    {bank.name}
                  </div>
