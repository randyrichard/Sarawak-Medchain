    ...
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white font-semibold">Generating Quarterly Report...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto space-y-6">
              ...
              <div className="space-y-4">
                <div className="bg-slate-700/50 rounded-xl p-4">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-white font-bold">RM {data.totalSubscriptionRevenue.toLocaleString()}</span>
                  </div>
                ...
                <div className="bg-slate-700/50 rounded-xl p-4">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-slate-300">Transaction Fees (RM 1.00/MC)</span>
                    <span className="text-white font-bold">RM {data.totalTransactionRevenue.toLocaleString()}</span>
                  </div>
                  <div className="w-full bg-slate-600 rounded-full h-2">
                    <div
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={index} className="flex items-center justify-between py-3 border-b border-slate-700 last:border-0">
                    ...
                    <span className="text-white font-semibold">RM {item.value.toLocaleString()}</span>
                  </div>
                ))}
        ...
        <div className="bg-slate-800 rounded-2xl p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    <div className="grid grid-cols-3 gap-4 text-center">
                      <div>
                        ...
                        <p className="text-white font-bold">{regionStats.transactions.toLocaleString()}</p>
                      </div>
                      <div>
                        <p className="text-slate-500 text-xs">Facilities</p>
                        <p className="text-white font-bold">{regionStats.hospitals + regionStats.clinics}</p>
                      </div>
                      <div>
            ...
            {/* Visual Map */}
            <div className="bg-slate-700/30 rounded-xl p-6 flex items-center justify-center">
                  ...
                  {data.churnRiskFacilities.map((facility, index) => {
                    ...
                    return (
                      <tr key={index} className="border-b border-slate-700/50 hover:bg-slate-700/30">
                        ...
                        <td className="py-4 px-4 text-slate-300">{facility.region}</td>
