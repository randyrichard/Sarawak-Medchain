    ...
    >
      <div className="max-w-[1600px] mx-auto flex items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-white">Founder Command</h1>
            <p className="text-xs text-slate-500">Real-time Control Center</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          {/* Command Bar Hint */}
          <div className="hidden lg:flex items-center gap-2 px-3 py-2 rounded-lg bg-slate-800/50 border border-slate-700/50">
            <svg className="w-4 h-4 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
            <span className="text-xs text-slate-500">Quick Search</span>
            <kbd className="px-1.5 py-0.5 text-[10px] bg-slate-700 rounded text-slate-400">Cmd+K</kbd>
          </div>
